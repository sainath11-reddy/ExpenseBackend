...
async function fn(e){
    ...
    // console.log(obj);
    let res = await axios.post("http://35.77.90.69:5000/admin/post-Expense",obj);
    // count++;
...
async function showUserOnScreen(e){
    e.preventDefault();
    let res = await axios.get("http://35.77.90.69:5000/admin/get-Expenses");
...
async function deleteItem(e){
    ...
    try{
        ...
        let res = await axios.get("http://35.77.90.69:5000/admin/delete-Expense/"+li.id);
        console.log(res);
        ul.removeChild(li);
